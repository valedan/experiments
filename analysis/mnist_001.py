...
plots_dir = Path("/home/dan/Dropbox/projects/exploration/analysis/001")
plots_dir.mkdir(exist_ok=True)
exp_dir = Path("/home/dan/Dropbox/projects/exploration/experiments/mnist/001")
...
for frac, df in frac_dfs.items():
    ...
    fig, axes = plt.subplots(
        w_count, d_count, sharex=True, sharey=True, figsize=(14, 14)
    )
    ...
    for idx, (run_id, run_data) in enumerate(df):
        ...
        ax.plot(
            run_data["step"], run_data["batch_train_loss"], label="Train Loss (Batch)"
        )
